...
class _ExploreState extends State<Explore> {
  ...
  Widget _buildBodyList(HomeProvider homeProvider) => ListView.builder(
//      itemCount: homeProvider.top?.feed?.links.length ?? 0,
  ...
  Widget _buildSectionHeader(Link link) => Padding(
  ...
  Widget _buildSectionBookList(Link link) => FutureBuilder<ParseData>(
