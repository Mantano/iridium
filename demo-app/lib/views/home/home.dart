...
class _HomeState extends State<Home> with AutomaticKeepAliveClientMixin {
  ...
  Widget _buildBody(HomeProvider homeProvider) => BodyBuilder(
        apiRequestStatus: homeProvider.apiRequestStatus,
        child: _buildBodyList(homeProvider),
        reload: () => homeProvider.getFeeds(),
      );

  Widget _buildBodyList(HomeProvider homeProvider) => RefreshIndicator(
  ...
  Widget _buildFeaturedSection(HomeProvider homeProvider) => SizedBox(
        height: 200.0,
        child: Center(
  ...
  Widget _buildGenreSection(HomeProvider homeProvider) => SizedBox(
        height: 50.0,
        child: Center(
          child: ListView.builder(
            primary: false,
  ...
  Widget _buildNewSection(HomeProvider homeProvider) => ListView.builder(
        primary: false,
        padding: const EdgeInsets.symmetric(horizontal: 15.0),
        shrinkWrap: true,
