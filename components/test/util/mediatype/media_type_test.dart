...
void main() {
  ...
  test("is OPDS", () {
    ...
    expect(MediaType.parse("application/opds-publication+json").isOpds, isTrue);
    expect(
        MediaType.parse("application/opds+json;charset=utf-8").isOpds, isTrue);
    expect(
        MediaType.parse("application/opds-authentication+json").isOpds, isTrue);
  });
  ...
  test("is publication", () {
    ...
    expect(MediaType.parse("application/audiobook+json").isPublication, isTrue);
    ...
    expect(
        MediaType.parse("application/vnd.comicbook+zip").isPublication, isTrue);
    ...
    expect(MediaType.parse("application/x.readium.w3c.wpub+json").isPublication,
        isTrue);
    expect(
        MediaType.parse("application/x.readium.zab+zip").isPublication, isTrue);
  });
}
